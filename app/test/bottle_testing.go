...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowBottleOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController, bottleID int) (http.ResponseWriter, *app.GoaExampleCom) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.GoaExampleCom
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.GoaExampleCom)
		if !ok {
			t.Fatalf("invalid response media: got variable of type %T, value %+v, expected instance of app.GoaExampleCom", resp, resp)
		}
		_err = mt.Validate()
		if _err != nil {
